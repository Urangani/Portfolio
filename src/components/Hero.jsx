...
<div className="flex flex-col lg:flex-row items-center lg:items-start">
  <div className="m-5 lg:w-1/2">
    ...
    <p className="mt-4 text-zinc-400">
      ...
      <p className="mt-4 text-zinc-400"> I build practical software systems with a focus on clean
      ...
      <p  className="mt-4 text-zinc-400"> Beyond code, I am a poet, gamer, and music
